$(document).ready(function() {
	...
	$('.s1').mouseover(function(){
		$('.logo').attr('src','image/logoTo.png');
	}).mouseout(function(){
	...
	$('.s2').mouseover(function(){
		...
		$('.require').attr('src','image/requireTo.png');
	}).mouseout(function(){
		$('.arrow2').removeClass('blue');
		$('.arrow_pointer2').removeClass('blue');
		$('.require').attr('src','image/require.png');
	});
	...
	$('.s3').mouseover(function(){
		...
		$('.service').attr('src','image/serviceTo.png');
	}).mouseout(function(){
		$('.arrow3').removeClass('green');
		$('.arrow_pointer3').removeClass('green');
		$('.service').attr('src','image/service.png');
	});
